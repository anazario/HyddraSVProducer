...
options.register('trackCollection',
                 ...
                 "Track collection: pf, lost, eleLost, merged (default), mergedWithEle, promptMuonExtracted, displacedMuonExtracted")
...
#   cmsRun testTrackAnalyzer_miniAOD_cfg.py inputFiles=file:myMiniAOD.root applyCuts=True
#
# With custom cut values:
#   cmsRun testTrackAnalyzer_miniAOD_cfg.py inputFiles=file:myMiniAOD.root applyCuts=True minPt=2.0 minAbsSip2D=3.0
#
